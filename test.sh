...
mongod --replSet rs1 --logpath "1.log" --dbpath db1 --port 27017 --oplogSize 64 --fork --smallfiles
...
mongod --replSet rs1 --logpath "3.log" --dbpath db4 --port 27019 --oplogSize 64 --smallfiles --fork